...
void SetupHardware()
{
	...
	// The below means the same thing as the above!!
	//DDRD = 0b11111100; // 1s outputs, 0s inputs
	//PORTD = 0b00000011; 
	...
	//DDRB = _BV(PB6); // Pin 10, aka row 0
	//DDRB |= _BV(PB2); // Pin 16, aka row 1
	//DDRD = 0b00100010; // Same as the above two lines
	//PORTB = 0b11111111; // Not necessary, but explicit
                                         ...
                                         uint16_t* const ReportSize)
{
	...
	//bool is_one = (~PIND & _BV(PD1));
	//bool is_zero = (~PIND & _BV(PD0));
